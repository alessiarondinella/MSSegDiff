...
class BasicUNetEncoder(nn.Module):
    ...
    def forward(self, x: torch.Tensor):
        ...
        x0 = self.conv_0(x) #torch.Size([2, 64, 96, 96, 96])
        x1 = self.down_1(x0) #torch.Size([2, 64, 48, 48, 48])
        x2 = self.down_2(x1) #torch.Size([2, 128, 24, 24, 24])
        x3 = self.down_3(x2) #torch.Size([2, 256, 12, 12, 12])
        x4 = self.down_4(x3) #torch.Size([2, 512, 6, 6, 6])
        #x5 = self.down_5(x4)
